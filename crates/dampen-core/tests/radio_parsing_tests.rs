...
fn test_parse_radio_with_label() {
    ...
    match label {
        dampen_core::AttributeValue::Static(s) => assert_eq!(s, "My Option"),
...
fn test_parse_radio_with_value() {
    ...
    match value {
        dampen_core::AttributeValue::Static(s) => assert_eq!(s, "test_value"),
...
fn test_parse_radio_with_selected_binding() {
    ...
    match selected {
        dampen_core::AttributeValue::Binding(_) => {

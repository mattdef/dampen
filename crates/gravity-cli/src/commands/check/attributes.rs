    ...
    pub fn for_widget(kind: &WidgetKind) -> Self {
        match kind {
            WidgetKind::Text => Self {
                ...
                optional: hashset!["size", "weight", "family", "line_height", "shaping"],
            ...
            WidgetKind::Image => Self {
                ...
                optional: hashset!["width", "height", "fit", "filter_method"],
                events: EVENTS_COMMON.clone(),
                style_attributes: STYLE_COMMON.clone(),
                layout_attributes: LAYOUT_COMMON.clone(),
            },
            ...
            WidgetKind::TextInput => Self {
                required: hashset![],
                optional: hashset!["placeholder", "value", "secure", "icon"],
            ...
            WidgetKind::Checkbox => Self {
                required: hashset![],
                optional: hashset!["checked", "label", "icon"],
            ...
            WidgetKind::Scrollable => Self {
                required: hashset![],
                optional: hashset!["direction", "scrollbar_width", "scrollbar_margin"],
            ...
            WidgetKind::Toggler => Self {
                required: hashset![],
                optional: hashset!["checked", "label"],
                events: hashset!["on_toggle"],
                style_attributes: STYLE_COMMON.clone(),
                layout_attributes: LAYOUT_COMMON.clone(),
            },
            ...
            WidgetKind::ProgressBar => Self {
                required: hashset![],
                optional: hashset!["value", "min", "max"],
                events: hashset![],
                style_attributes: STYLE_COMMON.clone(),
                layout_attributes: LAYOUT_COMMON.clone(),
            },
            WidgetKind::Tooltip => Self {
                required: hashset![],
                optional: hashset!["text", "position"],
                events: EVENTS_COMMON.clone(),
                style_attributes: STYLE_COMMON.clone(),
                layout_attributes: LAYOUT_COMMON.clone(),
            },
            ...
            WidgetKind::Float => Self {
                required: hashset![],
                optional: hashset!["anchor", "offset"],
                events: EVENTS_COMMON.clone(),
                style_attributes: STYLE_COMMON.clone(),
                layout_attributes: LAYOUT_COMMON.clone(),
            },
            WidgetKind::For => Self {
                required: hashset!["items"],

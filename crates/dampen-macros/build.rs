//! Build script for dampen-macros.
//!
//! This build script discovers `.dampen` files in the project and
...
fn main() {
    ...
    // Find all .dampen files recursively in the project
    discover_dampen_files(&manifest_dir);
...
/// Recursively discover all .dampen files and emit rerun-if-changed directives.
fn discover_dampen_files(manifest_dir: &PathBuf) {
    ...
    // Recursively find all .dampen files

...
//! - [`GravityDocument`] - Root document structure
...
//! implement any specific UI framework. See `gravity-iced` for the Iced backend.
//!
//! # Features
//!
...
/// a Gravity UI document, suitable for rendering or code generation.
pub use ir::{

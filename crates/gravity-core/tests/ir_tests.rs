use gravity_core::expr::{BindingExpr, Expr, FieldAccessExpr, LiteralExpr};
use gravity_core::ir::{
...
fn test_ir_serialization() {
    ...
    let deserialized: GravityDocument = serde_json::from_str(&json).unwrap();

...
use dampen_core::ir::{Background, WidgetState};
use dampen_core::{parse, HandlerRegistry};
use dampen_runtime::{StyleCascade, ThemeManager};
...
fn test_theme_validation() {
    use dampen_core::parser::theme_parser::parse_theme;
...
fn test_full_theme_spec() {
    ...
    assert_eq!(
        ...
        dampen_core::ir::theme::FontWeight::Bold
    );
    assert_eq!(theme.spacing.unit, 8.0);
}
...
fn test_gradient_mapping() {
    use dampen_core::ir::style::{Background, ColorStop, Gradient};
...
fn test_opacity_validation() {
    use dampen_core::parser::style_parser::parse_opacity;
...
fn test_shadow_parsing() {
    use dampen_core::parser::style_parser::parse_shadow_attr;
...
fn test_transform_parsing() {
    ...
    use dampen_core::parser::style_parser::parse_transform;
...
fn test_border_parsing() {
    use dampen_core::parser::style_parser::{
    ...
    assert_eq!(
        ...
        dampen_core::ir::style::BorderStyle::Solid
    );
...
fn test_circular_dependency_detection() {
    use dampen_core::parser::theme_parser::parse_style_class;
    use std::collections::HashMap;
...
fn test_class_with_layout() {
    ...
    assert_eq!(
        layout.width,
        Some(dampen_core::ir::layout::Length::Fixed(300.0))
    );
    assert_eq!(
        layout.height,
        Some(dampen_core::ir::layout::Length::Fixed(200.0))
    );

...
use dampen_core::ir::theme::{Theme, ThemePalette};
...
impl ThemeManager {
    ...
    pub fn load_from_document(&mut self, doc: &DampenDocument) {
        // Load custom themes
    ...
    fn light_theme() -> Theme {
        Theme {
            ...
            palette: ThemePalette {
                primary: dampen_core::ir::style::Color::parse("#3498db").unwrap(),
                secondary: dampen_core::ir::style::Color::parse("#2ecc71").unwrap(),
                success: dampen_core::ir::style::Color::parse("#27ae60").unwrap(),
                warning: dampen_core::ir::style::Color::parse("#f39c12").unwrap(),
                danger: dampen_core::ir::style::Color::parse("#e74c3c").unwrap(),
                background: dampen_core::ir::style::Color::parse("#ecf0f1").unwrap(),
                surface: dampen_core::ir::style::Color::parse("#ffffff").unwrap(),
                text: dampen_core::ir::style::Color::parse("#2c3e50").unwrap(),
                text_secondary: dampen_core::ir::style::Color::parse("#7f8c8d").unwrap(),
            },
            ...
            spacing: dampen_core::ir::theme::SpacingScale { unit: 4.0 },
    ...
    fn dark_theme() -> Theme {
        Theme {
            ...
            palette: ThemePalette {
                ...
                warning: dampen_core::ir::style::Color::parse("#f39c12").unwrap(),
                danger: dampen_core::ir::style::Color::parse("#e74c3c").unwrap(),
                background: dampen_core::ir::style::Color::parse("#2c3e50").unwrap(),
                surface: dampen_core::ir::style::Color::parse("#34495e").unwrap(),
                text: dampen_core::ir::style::Color::parse("#ecf0f1").unwrap(),
                text_secondary: dampen_core::ir::style::Color::parse("#bdc3c7").unwrap(),
            },
            typography: dampen_core::ir::theme::Typography {
                font_family: "sans-serif".to_string(),
                font_size_base: 16.0,
